...
\begin{verbatim}1 row updated. \end{verbatim}
{\color{blue}
\begin{verbatim}
...
\begin{verbatim}-- note no response, for now this SQL session is hanging \end{verbatim}
{\color{blue}
\begin{verbatim}
SQL> update accounts set balance = balance + 250 
                         where account_number = 1;
...
\begin{verbatim}-- this session hangs, but in the other SQL session we get
        the following error message: \end{verbatim}
{\color{blue}
\begin{verbatim}
SQL>update accounts set balance = balance + 100 
                where account_number = 2
