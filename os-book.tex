...
%% Network bandwidth and disk capacity have become sufficiently
%% more plentiful over the course of the 1.1.x versions that
%% as of version 1.2, I'm changing the default to \fancytitlepagetrue
%% and distributing the PDF in that fancy style. However, it
%% can be turned off by anyone more frugal.
%%
\fancytitlepagetrue
%%
...
\date{Revised Edition 1.3.1\\\today}
\makeindex
\begin{document}
...
\noindent Copyright \copyright\ 2011--2019 by Max Hailperin.
